<?
	...
	$Pass = $_GET["Pass"];
	$Limit = $_GET["Limit"];
	$IncludeContact = $_GET["IncludeContact"];
	...
	if ($Pass == "Kirk4226652") {
		...
		$ch = curl_init("https://messages.att.net/messages/v0/all?includeContactInfo=$IncludeContact&limit=$Limit&threadKeys=$ThreadKey&offset=0");
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
